...
$conn = new mysqli ( $servername, $username, $password, $dbname ) or die( "Connection failed: " . $conn->connect_error );
	...
	$limit = $_POST['limit']; // This is named 'limit' because the checkbox in createEditRoom.php is named 'limit'
	...
	if ($beingEdited == 1){ // If we are editing the room
		...
		$_createSql = "INSERT INTO `rooms` (`roomid`, `type`, `floor`, `seats`, `hascomputers`, `numcomputers`, `limitusers`) VALUES ('$roomid', '$type', '$floor', '$seats', '$hasComputers', '$numComputers', '$limit')";
